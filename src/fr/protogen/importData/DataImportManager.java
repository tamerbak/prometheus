...
public class DataImportManager implements DataFormatDriver {

	private DAL dal;
	private DataStructure data=new DataStructure();
	private static DataImportManager instance;
	...
	public static DataImportManager getInstance(){
		if(instance==null){
			instance=new DataImportManager();
		}
		return instance;
	}
	...
	public CheckStatus chechFormat(String filename) {
		...
		try {
			...
			System.out.println("fataaaaaaaaaal");
			return statu;
		} catch (IOException e) {
			// e.printStackTrace();
